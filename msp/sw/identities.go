...
func newIdentity(cert *x509.Certificate, pk bccsp.Key, msp *bccspmsp) (msp2.Identity, error) {
...
func newSigningIdentity(cert *x509.Certificate, pk bccsp.Key, signer crypto.Signer, msp *bccspmsp) (msp2.SigningIdentity, error) {
